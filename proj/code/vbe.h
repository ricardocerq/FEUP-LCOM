...
#define GET_PHYS_ADDR(ptr) (((ptr & 0xFFFF0000) >> 12) +(ptr & 0xFFFF))
#define GET_BASE(ptr) (ptr & 0xF0000000)
#define GET_ADDR(farptr, base) (GET_PHYS_ADDR(farptr)+ base)
...
///@brief return informtion of vbe controller
///@param vmi_p struct to fill
///@param base return segment
///@return 0 on success, non-zero otherwise
int vbe_get_controller_info(vbe_controller_info_t *vmi_p, void** base);


///@brief print the vbe version on the screen
///@param version vbe version
